...
export function PetsPreview() {
  const featured = petsData.filter((p) => p.featured && p.available).slice(0, 6)
    ...
    <section id="adopta" className="py-16 md:py-20 bg-gray-50 scroll-mt-24">
      <div className="container mx-auto px-4">
            ...
            >
              <div className="relative aspect-[4/3] bg-gray-100 overflow-hidden">
                ...
                {pet.photo && (
                  <Image
                    src={pet.photo}
                    alt={`${pet.name}, ${pet.breed} ${pet.age} en adopción`}
                    fill
        ...
        <div className="text-center mt-10">
          ...
          >
            Ver cómo adoptar <ArrowRight className="h-4 w-4" />
          </Link>
        </div>
      </div>
    </section>
