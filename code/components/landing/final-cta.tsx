...
export function FinalCTA() {
  ...
  return (
    <section id="cta-final" className="py-16 md:py-24 bg-brand-green text-white scroll-mt-24" aria-labelledby="cta-title">
      <div className="container mx-auto px-4 text-center">
        <h2 id="cta-title" className="text-3xl md:text-4xl font-bold mb-4 text-balance">
